...
class ContactsApplicationTests {
    ...
    @Autowired
    private ObjectMapper objectMapper;  //ObjectMapper Converts the java object to JSON.
	...
	public void validContactCreation() throws Exception {
        RequestBuilder postRequest = MockMvcRequestBuilders.post("/contact").contentType(MediaType.APPLICATION_JSON) //.contentType specifies that the type of object I'm sending is JSON.
	...
	public void invalidContactCreation() throws Exception {
        RequestBuilder postRequest = MockMvcRequestBuilders.post("/contact").contentType(MediaType.APPLICATION_JSON)
